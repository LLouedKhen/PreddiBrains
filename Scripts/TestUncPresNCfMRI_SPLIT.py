...
from utils import draw_cube_intro, generate_random_lines_in_cube_area, draw_cube, inverse_logistic, logiF
...
subjData = subjData.loc[:, ~subjData.columns.str.contains('^Unnamed')]
...
if lang == 'E':      
    ...
    Quest2 = visual.TextStim(win, text = 'From below or from above?', 
    font='Arial',
...
dat33.to_csv('StimulusPresentationNC_' + subjNum +'.csv')
...
if lang == 'E': 
    ...
    secondText = visual.TextStim(win=win, text='This is a Necker Cube viewed from above. Press any key to continue.', font='', pos=(0, -0.6),
    depth=0, rgb=None, color='black', colorSpace='rgb', opacity=1.0, contrast=1.0, units='', 
    ori=0.0, height = 0.05, antialias=True, bold=True, italic=False, anchorVert='center', anchorHoriz='center',
    fontFiles=(), flipHoriz=False, flipVert=False, languageStyle='LTR', name=None, autoLog=None)
    
    thirdText = visual.TextStim(win=win, text='This is a Necker Cube viewed from below. Press any key to continue.', font='', pos=(0, -0.6),
    depth=0, rgb=None, color='black', colorSpace='rgb', opacity=1.0, contrast=1.0, units='', 
    ori=0.0, height = 0.05, antialias=True, bold=True, italic=False, anchorVert='center', anchorHoriz='center',
    fontFiles=(), flipHoriz=False, flipVert=False, languageStyle='LTR', name=None, autoLog=None)
    ...
    secondText = visual.TextStim(win=win, text="Ceci est le cube Necker vu d'en haut. Appuyez sur une touche pour continuer.", font='', pos=(0, -0.6),
    depth=0, rgb=None, color='black', colorSpace='rgb', opacity=1.0, contrast=1.0, units='', 
    ori=0.0, height = 0.05, antialias=True, bold=True, italic=False, anchorVert='center', anchorHoriz='center',
    fontFiles=(), flipHoriz=False, flipVert=False, languageStyle='LTR', name=None, autoLog=None)
    
    thirdText = visual.TextStim(win=win, text="Ceci est le cube Necker vu d'en bas. Appuyez sur une touche pour continuer.", font='', pos=(0, -0.6),
    depth=0, rgb=None, color='black', colorSpace='rgb', opacity=1.0, contrast=1.0, units='', 
    ori=0.0, height = 0.05, antialias=True, bold=True, italic=False, anchorVert='center', anchorHoriz='center',
    fontFiles=(), flipHoriz=False, flipVert=False, languageStyle='LTR', name=None, autoLog=None)
...
#ambiguous Cube 
draw_cube_intro(0.5, firstText, win)
win.flip()

#Below Bias Cube 
draw_cube_intro(0.0, secondText, win)
win.flip()

#Above Bias Cube 
draw_cube_intro(1, thirdText, win)
win.flip()
...
for block in range(2):
    ...
    allRes.to_csv('NCI_' + subjNum + 'Block' + str(b) + '.csv')
...
for i in allpVals:
    ...
    count = np.sum(thisB['Percept'].astype(str) == '1') # just to be sure 
...
# Fit the curve
popt, pcov = curve_fit(logiF, allpVals, score, p0=ass) # could fail if doesn't find the good parameters
...
# Plotting
x_fit = np.linspace(min(allpVals), max(allpVals), 200)
...
fig.savefig(os.path.join(subjPath, 'NC' + subjNum + '_DataFit.png'))  # save the figure to file
